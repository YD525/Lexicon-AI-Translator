...
{
    public partial class PhoenixTranslatorRadarChart : UserControl
    {
        ...
        public static readonly DependencyProperty TranslationQualityProperty =
            DependencyProperty.Register("TranslationQuality", typeof(double), typeof(PhoenixTranslatorRadarChart),
                new PropertyMetadata(80.0, OnValueChanged));

        public static readonly DependencyProperty TranslationSpeedProperty =
            DependencyProperty.Register("TranslationSpeed", typeof(double), typeof(PhoenixTranslatorRadarChart),
                new PropertyMetadata(70.0, OnValueChanged));

        public static readonly DependencyProperty ResourceOverheadProperty =
            DependencyProperty.Register("ResourceOverhead", typeof(double), typeof(PhoenixTranslatorRadarChart),
                new PropertyMetadata(50.0, OnValueChanged));

        public static readonly DependencyProperty AutomationProperty =
            DependencyProperty.Register("Automation", typeof(double), typeof(PhoenixTranslatorRadarChart),
                new PropertyMetadata(60.0, OnValueChanged));

        public static readonly DependencyProperty ManualizationProperty =
            DependencyProperty.Register("Manualization", typeof(double), typeof(PhoenixTranslatorRadarChart),
        ...
        public static readonly DependencyProperty ShowLevelValuesProperty =
            DependencyProperty.Register("ShowLevelValues", typeof(bool), typeof(PhoenixTranslatorRadarChart),
        ...
        {
            ((PhoenixTranslatorRadarChart)D).UpdateRadar();
        }
        ...
        private static readonly DependencyProperty DisplayTranslationQualityProperty =
            DependencyProperty.Register("DisplayTranslationQuality", typeof(double), typeof(PhoenixTranslatorRadarChart),
        ...
        private static readonly DependencyProperty DisplayTranslationSpeedProperty =
            DependencyProperty.Register("DisplayTranslationSpeed", typeof(double), typeof(PhoenixTranslatorRadarChart),
        ...
        private static readonly DependencyProperty DisplayResourceOverheadProperty =
            DependencyProperty.Register("DisplayResourceOverhead", typeof(double), typeof(PhoenixTranslatorRadarChart),
                new PropertyMetadata(50.0, OnDisplayValueChanged));

        private static readonly DependencyProperty DisplayAutomationProperty =
            DependencyProperty.Register("DisplayAutomation", typeof(double), typeof(PhoenixTranslatorRadarChart),
                new PropertyMetadata(60.0, OnDisplayValueChanged));

        private static readonly DependencyProperty DisplayManualizationProperty =
            DependencyProperty.Register("DisplayManualization", typeof(double), typeof(PhoenixTranslatorRadarChart),
        ...
        {
            PhoenixTranslatorRadarChart Chart = (PhoenixTranslatorRadarChart)D;
        ...
        public PhoenixTranslatorRadarChart()
        {
            InitializeComponent();
