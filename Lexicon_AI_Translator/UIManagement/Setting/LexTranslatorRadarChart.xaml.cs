...
namespace LexTranslator
{
    public partial class LexTranslatorRadarChart : UserControl
    {
        ...
        public static readonly DependencyProperty TranslationQualityProperty =
            DependencyProperty.Register("TranslationQuality", typeof(double), typeof(LexTranslatorRadarChart),
                new PropertyMetadata(80.0, OnValueChanged));

        public static readonly DependencyProperty TranslationSpeedProperty =
            DependencyProperty.Register("TranslationSpeed", typeof(double), typeof(LexTranslatorRadarChart),
                new PropertyMetadata(70.0, OnValueChanged));

        public static readonly DependencyProperty ResourceOverheadProperty =
            DependencyProperty.Register("ResourceOverhead", typeof(double), typeof(LexTranslatorRadarChart),
                new PropertyMetadata(50.0, OnValueChanged));

        public static readonly DependencyProperty AutomationProperty =
            DependencyProperty.Register("Automation", typeof(double), typeof(LexTranslatorRadarChart),
                new PropertyMetadata(60.0, OnValueChanged));

        public static readonly DependencyProperty ManualizationProperty =
            DependencyProperty.Register("Manualization", typeof(double), typeof(LexTranslatorRadarChart),
        ...
        public static readonly DependencyProperty ShowLevelValuesProperty =
            DependencyProperty.Register("ShowLevelValues", typeof(bool), typeof(LexTranslatorRadarChart),
        ...
        private static readonly DependencyProperty DisplayTranslationQualityProperty =
            DependencyProperty.Register("DisplayTranslationQuality", typeof(double), typeof(LexTranslatorRadarChart),
        ...
        private static readonly DependencyProperty DisplayTranslationSpeedProperty =
            DependencyProperty.Register("DisplayTranslationSpeed", typeof(double), typeof(LexTranslatorRadarChart),
        ...
        private static readonly DependencyProperty DisplayResourceOverheadProperty =
            DependencyProperty.Register("DisplayResourceOverhead", typeof(double), typeof(LexTranslatorRadarChart),
                new PropertyMetadata(50.0, OnDisplayValueChanged));

        private static readonly DependencyProperty DisplayAutomationProperty =
            DependencyProperty.Register("DisplayAutomation", typeof(double), typeof(LexTranslatorRadarChart),
                new PropertyMetadata(60.0, OnDisplayValueChanged));

        private static readonly DependencyProperty DisplayManualizationProperty =
            DependencyProperty.Register("DisplayManualization", typeof(double), typeof(LexTranslatorRadarChart),
        ...
        {
            LexTranslatorRadarChart Chart = (LexTranslatorRadarChart)D;
